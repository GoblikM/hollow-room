...
const canvasStyle = { borderRadius: "var(--radius)", border: "1px solid var(--color-outline)" };
    ...
    <div className="flex flex-col gap-6 md:flex-row md:items-start">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-1">
          ...
          <canvas ref={chartCanvasRef} width={SIZE} height={CHART_HEIGHT} style={canvasStyle} />
        </div>
      </div>

      {/* RIGHT — settings panel */}
      <div className="flex w-full flex-col gap-4 p-4 font-mono text-sm md:w-64" style={panelBox}>
        {/* Function */}
        <label className="flex flex-col gap-1">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex-1 px-3 py-2 font-pixel text-xs uppercase tracking-wide"
            style={buttonStyle}
          >
